  ...
  return (
    <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-walmart-darkBlue">Bon retour !</h1>
        <p className="text-gray-500 mt-2">Connectez-vous pour accéder à vos commandes Asim.</p>
      </div>
      ...
      <form action={onSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input id="password" name="password" type="password" required placeholder="••••••••" className="w-full px-4 py-3 text-gray-900 border border-gray-200 rounded-lg focus:ring-2 focus:ring-walmart-blue outline-none" />
        </div>
