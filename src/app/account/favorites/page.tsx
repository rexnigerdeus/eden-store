    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-walmart-darkBlue">Mes Favoris ❤️</h1>
          <p className="text-sm sm:text-base text-gray-500 mt-2">Bonjour {profile?.full_name}, voici les articles que vous avez mis de côté.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="md:col-span-1 space-y-2">
            <div className="bg-white p-3 sm:p-4 rounded-xl border border-gray-200 shadow-sm space-y-1">
              <Link href="/account" className="block px-3 py-2 text-sm sm:text-base text-gray-600 hover:bg-gray-50 font-medium rounded-lg transition-colors">
                Mes commandes
              </Link>
              ...
              <Link href="/account/favorites" className="block px-3 py-2 text-sm sm:text-base bg-blue-50 text-walmart-blue font-medium rounded-lg">
                Mes favoris
              </Link>
              <Link href="/track" className="block px-3 py-2 text-sm sm:text-base text-gray-600 hover:bg-gray-50 font-medium rounded-lg transition-colors mt-1">
                Suivi rapide (Invité)
              </Link>
            </div>
          </div>
          ...
          <div className="md:col-span-3">
            {favoriteProducts.length === 0 ? (
              <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 sm:p-12 text-center">
                ...
                <h3 className="text-lg sm:text-xl font-medium text-gray-900">Aucun favori pour le moment</h3>
                <p className="text-sm sm:text-base text-gray-500 mt-2">Explorez nos boutiques et cliquez sur le cœur pour mettre des articles de côté !</p>
                <Link href="/" className="inline-block mt-6 px-5 py-2.5 text-sm sm:text-base bg-walmart-blue text-white rounded-lg hover:bg-blue-700 transition-colors">
