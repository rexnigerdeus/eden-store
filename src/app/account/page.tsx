  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-walmart-darkBlue">Mon Espace Client</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-2">
            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
              <Link href="/account" className="block px-4 py-2 bg-blue-50 text-walmart-blue font-medium rounded-lg">
                Mes commandes
              </Link>
              ...
              <Link href="/track" className="block px-4 py-2 text-gray-600 hover:bg-gray-50 font-medium rounded-lg mt-1 transition-colors">
                Suivi rapide (Invité)
              </Link>
            </div>
          </div>
          ...
          <div className="md:col-span-3 space-y-6">
            <h2 className="text-xl font-bold text-gray-900">Historique de mes commandes</h2>
            ...
            {orders && orders.length > 0 ? (
                    ...
                    <div className="flex-1 space-y-4">
                      {order.order_items.map((item: any) => (
                        <div key={item.id} className="flex items-center space-x-4">
                          ...
                          <div>
                            <p className="font-medium text-gray-900">{item.products?.title || 'Article indisponible'}</p>
              ...
              <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Vous n'avez pas encore de commandes</h3>
                <Link href="/" className="text-walmart-blue hover:underline font-medium">
