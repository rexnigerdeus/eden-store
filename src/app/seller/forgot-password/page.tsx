...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-walmart-light p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-md bg-white p-5 sm:p-8 rounded-xl shadow-sm border border-gray-100 space-y-6 sm:space-y-8">
        
        <div className="text-center">
          <h1 className="text-xl sm:text-2xl font-semibold text-walmart-darkBlue">Mot de passe oublié ?</h1>
        ...
        {message && (
          <div className={`p-3 sm:p-4 text-xs sm:text-sm rounded-md text-center ${message.type === 'success' ? 'text-green-700 bg-green-50' : 'text-red-700 bg-red-50'}`}>
            {message.text}
          </div>
        )}

        <form action={onSubmit} className="space-y-5 sm:space-y-6">
          <div>
          ...
          <button
            ...
            className={`w-full py-2.5 sm:py-3 px-4 text-sm sm:text-base text-white rounded-lg font-medium transition-colors ${
